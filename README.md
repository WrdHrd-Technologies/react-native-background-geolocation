...
| `heartbeatInterval`      | `Number`          | Android      | The minimum time interval between location updates in milliseconds when device enter in stationary mode. 0 means no location update after entering in stationary mode.                                                                                     | DIST         | 0                      | 
